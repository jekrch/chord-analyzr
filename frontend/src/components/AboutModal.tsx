                ...
                <div className="mcb-inset overflow-hidden">
                    ...
                    <div className="p-4 space-y-3">
                        <a
                            ...
                            className="flex items-center space-x-3 p-3 rounded-lg bg-[color-mix(in_srgb,var(--mcb-bg-secondary)_50%,transparent)] hover:bg-[var(--mcb-bg-hover)] transition-all duration-200 group"
                        >
                            <div className="w-8 h-8 flex items-center justify-center rounded-full bg-[var(--mcb-border-primary)] group-hover:bg-[var(--mcb-border-secondary)] transition-colors">
